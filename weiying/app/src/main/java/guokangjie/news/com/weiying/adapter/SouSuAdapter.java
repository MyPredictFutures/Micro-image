...
public class SouSuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<SouSuoBean.RetBean.ListBean> list;
    private String dataId;

    public SouSuAdapter(Context context, List<SouSuoBean.RetBean.ListBean> list) {
